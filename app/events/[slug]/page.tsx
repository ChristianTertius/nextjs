    ...
    <section id="event">
      ...
      <div className="details">
        ...
        <div className="content">
          <Image src={image} width={800} height={800} className="banner" alt="Event Banner" />
        ...
        <aside className="booking">
          <div className="signup-card">
            ...
            {bookings > 0 ? (
              <p className="text-sm">
                Join {bookings} people who have already bookings their spot!
              </p>
            ) : (
              <p className="text-sm">Be the first to book your sport</p>
            )}
